...
<body>
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-header">
				...
				<h4 class="page-header">Logins</h4>
				<form class="form-horizontal" role="form">
						...
						<div class="text-center center-block" style="margin-top:1%;"><button type="button" id="submit" class="btn btn-primary center-block">SAVE</button></div>
	...
	<script src="<c:url value="/resources/js/userSettings.js" />"></script>
</body>
</html>