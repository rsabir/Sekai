		...
		<div class="box">
				...
				<h4 class="page-header">The local Config.json</h4>
					<form class="form-horizontal" role="form">
						...
						<div class="text-center center-block" style="margin-top:1%;"><button type="button" class="btn btn-primary center-block">FINISH</button></div>
						<div id="error"></div>
